[![build](https://github.com/opspec-pkgs/golang.coverprofile.assert/actions/workflows/build.yml/badge.svg)](https://github.com/opspec-pkgs/golang.coverprofile.assert/actions/workflows/build.yml)
